...
import { postChargesheet, postUpdate } from '../Utilities/Queries';

const FileChargesheet = ({FIRId}) => {
  ...
  const handleSubmit = () => {
    ...
    postChargesheet(formData, setIsSubmitting);
  };
...
export default FileChargesheet;
