...
import { color, elasticSearchPassword, elasticSearchUserName } from '../../../GlobalConfig/config';
...
const Login = () => {
    ...
    function doLogin() {
        ...
        axios
            .post('https://api.web-project.in/manage/officer/auth/login', loginData)
            .then((res) => {
                console.log(res);
                setAlertMessage('Login successful!');
                navigate(`/analytics-select-ps`);
