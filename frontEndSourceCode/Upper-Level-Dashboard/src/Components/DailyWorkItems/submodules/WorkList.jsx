    ...
    <>
      {step === 1 && (
        <div style={{
          ...
          <SelectPoliceStation />
          <div style={{ marginTop: "25px", marginBottom: "20px", display: "flex", alignItems: "center", justifyContent: "center" }}>
              ...
              <Table>
                <TableHead>
                  <TableRow sx={{ background: config.color.color5 }}>
                    <TableCell sx={{ color: config.color.color9, fontSize: "20px", paddingLeft: "70px" }}>Work Item Id</TableCell>
                    <TableCell sx={{ color: config.color.color9, fontSize: "20px" }}>Title</TableCell>
                    <TableCell sx={{ color: config.color.color9, fontSize: "20px" }}>Submitted Time</TableCell>
                  </TableRow>
                </TableHead>
