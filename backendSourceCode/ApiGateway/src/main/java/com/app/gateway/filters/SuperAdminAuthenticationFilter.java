...
import com.app.gateway.filters.PoliceStationAuthenticationFilter.Config;
import com.app.gateway.services.JwtService;

@Component
public class SuperAdminAuthenticationFilter extends AbstractGatewayFilterFactory<SuperAdminAuthenticationFilter.Config>{
	@Autowired
