...
@Component
public class SocialMediaAuthenticationFilter extends AbstractGatewayFilterFactory<SocialMediaAuthenticationFilter.Config>{
	...
	public SocialMediaAuthenticationFilter() {
		super(Config.class);
	}
	@Override
		...
		return ((exchange,chain)->{
			if(validator.isSecured.test(exchange.getRequest())) {
				...
				try {
					...
					if(!res.equals("social-media-user")) {
